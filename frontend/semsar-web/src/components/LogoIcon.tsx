...
export const LogoIcon = memo(function LogoIcon({ variant = 'navy' }: LogoIconProps) {
  if (variant === 'gold') {
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none" className="w-full h-full" role="img" aria-label="Semsar" focusable="false">
