  ...
  return (
    <div className="min-h-screen bg-background pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        <button onClick={() => { if (project?.slug) navigate(`/projects/${project.slug}`); else navigate(-1); }} className="inline-flex items-center gap-2 text-muted-foreground hover:text-foreground mb-6 sm:mb-8 font-medium text-sm transition-colors group p-3 -ml-3 min-h-[44px]">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 sm:gap-6 py-4 sm:py-6 border-y border-border">
                <div className="flex items-center gap-3">
                  <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-secondary/10 flex items-center justify-center text-secondary"><Building className="w-5 h-5" /></div>
                  <div>
                    <div className="text-xs text-muted-foreground uppercase tracking-wide">{t('property.type')}</div>
                    <div className="font-bold text-sm sm:text-base">{t(`prop_type.${unit.propertyType}`)}</div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-sm sm:text-base">{fmtNum(unit.size)} {t('general.m2')}</div>
                  </div>
                </div>
                {unit.bedrooms != null && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-sm sm:text-base">{fmtNum(unit.bedrooms)}</div>
                    </div>
                  </div>
                )}
                {unit.bathrooms != null && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-sm sm:text-base">{fmtNum(unit.bathrooms)}</div>
                    </div>
                  </div>
                )}
                {unit.floor != null && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-sm sm:text-base">{fmtNum(unit.floor)}</div>
                    </div>
                  </div>
                )}
                {unit.view && unit.view !== 'Unknown' && (
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-sm sm:text-base">{t(`view.${unit.view}`)}</div>
                    </div>
                  </div>
                )}
              </div>
