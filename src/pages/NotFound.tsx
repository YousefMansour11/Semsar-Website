    ...
    <div className="min-h-screen bg-background pt-20">
      ...
      <main className="flex items-center justify-center bg-muted flex-1 min-h-[60vh]">
        <div className="text-center px-4">
          ...
          <Link to={localizedPath('/', language)} className="inline-flex items-center mt-2 px-8 min-h-[48px] bg-navy text-white rounded-xl font-semibold hover:bg-navy-light transition-all hover:shadow-lg active:scale-[0.98]">
