      ...
      <div className="bg-white/95 backdrop-blur-xl border-t border-border/30 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] rounded-t-2xl px-3 pt-2.5 pb-[max(env(safe-area-inset-bottom,0px),8px)]">
        <div className="flex items-center gap-2.5">
          <a
            ...
            className="flex-1 flex items-center justify-center gap-1.5 h-12 rounded-xl bg-green-500/10 text-green-600 font-medium text-xs transition-all duration-200 hover:bg-green-500/20 hover:shadow-sm active:scale-[0.97]"
          >
          ...
          <a
            href={phoneHref}
            className="flex-1 flex items-center justify-center gap-1.5 h-12 rounded-xl bg-primary/10 text-primary font-medium text-xs transition-all duration-200 hover:bg-primary/20 hover:shadow-sm active:scale-[0.97]"
          >
